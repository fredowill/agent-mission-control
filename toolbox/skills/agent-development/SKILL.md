...
**Bad examples:** `helper` (too generic), `-agent-` (starts/ends with hyphen), `my_agent` (underscores not allowed)
...
Restrict agent to specific tools. If omitted, agent has access to all tools.
